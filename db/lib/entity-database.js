...
function EntityDatabase(dbName, server, options) {
    ...
    this.addCacheRule = async function (collection, field, seconds) {
        const client = await MongoClient.connect(this.server.connection, { useNewUrlParser: true, useUnifiedTopology: true })
            .catch(function (err) { });
    ...
    if (this.options !== undefined) {
        if (this.options.cache !== undefined) {
            if (this.options.cache.collection !== undefined &&
                ...
                console.log("The creation of the cache will be executed");
